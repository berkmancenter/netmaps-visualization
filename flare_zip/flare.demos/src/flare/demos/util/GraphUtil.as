...
static private function loadData(loader:URLLoader ):void 
{  
var query:String = "http://localhost/asn_web_graphs/results/graphs/asn-India.graphml"; 
...
static private function configListeners(dispatcher:IEventDispatcher):void { 
// Add a completion event listener 
dispatcher.addEventListener(Event.COMPLETE, completeHandler);  
} 
    public static function asnGraph() : Data
	    {
...
var loader:URLLoader = new URLLoader(); 
 	    ...
 	    //    while (!gxml_loaded) {};
			...
			return Data.fromDataSet(dataSet);  	    	
	    }    
