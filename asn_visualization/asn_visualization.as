package
{
   ...
   //     private var _layout_format_toogle:TextSprite;
		...
		private function create_toggle_sprite(true_text:String, false_text:String, 
			true_function:Function, false_function:Function,toggle_start:Boolean):Sprite
		{
		...
		private function create_layout_format_toogle(layout_format:uint):void
		{
			...
			_layout_format_toggle_container = create_toggle_sprite("CIRCLE LAYOUT", "RADIAL LAYOUT", 
				function():void {updateOperators(CIRCLE_LAYOUT)}, 
				function():void{updateOperators(RADIAL_LAYOUT)}, layout_is_circle);
